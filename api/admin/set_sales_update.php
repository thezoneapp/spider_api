<?
	...
	* parameter ==> assort:     매출구분
	* parameter ==> price:      매출금액
	...
	*/
	...
	if ($mode == "insert") {
		$sql = "INSERT INTO sales (sponsId, sponsName, memId, memName, assort, price, accurateStatus, wdate)
		...
		$sql = "UPDATE sales SET sponsId = '$sponsId', 
		                         sponsName = '$sponsName', 
							     memId = '$memId', 
								 memName = '$memName', 
								 assort = '$assort', 
