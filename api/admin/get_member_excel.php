<?
	...
	*/
    ...
    $sql = "SELECT no, idx, leg, sponsId, recommandId, memId, memName, registNo, hpNo, gajaId, accountName, accountNo, accountBank, memAssort, cmsStatus, contractStatus, joinPayStatus, memStatus, wdate 
	        FROM ( select @a:=@a+1 no, idx, leg, sponsId, recommandId, memId, memName, registNo, hpNo, gajaId, accountName, accountNo, accountBank, memAssort, cmsStatus, contractStatus, joinPayStatus, memStatus, date_format(wdate, '%Y-%m-%d') as wdate 
