<?
	...
	*/
	...
	if ($mode == "insert") {
		$sql = "INSERT INTO hp_commi (telecom, assortCode, modelCode, priceNew, priceMnp, priceChange, useYn)
						      VALUES ('$telecom', '$assortCode', '$modelCode', '$priceNew', '$priceMnp', '$priceChange', '$useYn')";
		$connect->query($sql);
		...
		$sql = "UPDATE hp_commi SET telecom = '$telecom',
